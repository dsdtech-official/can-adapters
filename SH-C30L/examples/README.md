...
SH-C30L has shipped with **two different firmwares** over its life. **Both are in the
...
SH-C30L itself. Treat the floor below as applying here until we publish a measurement
taken on this board.
