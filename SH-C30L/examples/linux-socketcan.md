...
>
> SH-C30L has shipped with **two different firmwares**, both of which are in the field
...
> SH-C30L itself.** The table below is what we would assume here; confirm it on your own
...
✅ **Measured on both SH-C30L firmwares** (2026-09-15): with the adapter in `listen-only`,
...
>
> (SH-C30L is not affected. This is exactly why the identify step at the top matters.)
