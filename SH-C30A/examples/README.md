...
*(SH-C30A has no CAN FD — the STM32F072 on this board has a classic CAN controller.
...
SH-C30A has shipped with **two different firmwares** over its life. **Both are in the
